  ...
  <form action="{{route('admin.product.create.post')}}" method="POST" enctype="multipart/form-data">
    ...
    <form id="myForm" name="myForm" class="form-horizontal" >
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" id="stock" placeholder="Nhập tồn kho" name="stock">
                            </div>
                            <div class="form-group">
                                <label>Đơn vị tính:</label>
                                <input type="text" class="form-control" id="unit" placeholder="Nhập đơn vị tính" name="unit">
                            </div>
                            <div class="form-group">
